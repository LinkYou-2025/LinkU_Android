 ...
 *
 * AI 요약 목록의 특성에 맞춰 AI 북마크를 항상 표시하고 외부 링크 아이콘은 숨깁니다. 서버가
 * 양수 [AiArticleLink.userLinkuId]를 제공한 항목만 상세 이동과 더보기 및 삭제 동작을 제공합니다.
 *
...
/**
 * 유효한 사용자 저장 링크 ID가 있을 때만 해당 ID를 전달하는 클릭 동작을 만듭니다.
 *
 * @param userLinkuId 서버가 반환한 사용자 저장 링크 ID
 * @param onClick 유효한 ID를 전달받을 원본 콜백
 * @return 양수 ID를 전달하는 클릭 동작. ID가 없거나 0 이하이면 `null`
 */
