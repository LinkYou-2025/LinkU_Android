...
val purposes = listOf(
    ...
    Purpose("📝", "학업/리포트 정리", 120f, DpOffset(230.dp, 180.dp)),
    Purpose("💼", "업무자료 아카이브", 130f, DpOffset(220.dp, 350.dp)),
    Purpose("💡", "사이트 프로젝트\n창업 준비", 160f, DpOffset(60.dp, 120.dp)),

    Purpose("📅", "그냥 나중에\n보고 싶은 글 저장", 220f, DpOffset(-60.dp, 280.dp)),
    Purpose("❓", "기타", 80f, DpOffset(160.dp, 280.dp)),
    Purpose("💻", "블로그/콘텐츠 작성 참고용", 120f, DpOffset(340.dp, 60.dp)),
...
fun InterestPurposeScreen(
    ...
    // ❗ [수정 1] 지금은 Column + weight 로 버튼을 고정했는데
    //    작은 화면에서 내용과 버튼이 겹치는 문제가 발생함.
    ...
    Scaffold(
        ...
        //  [수정 3] LazyColumn 으로 바꿔서 작은 화면에서도 스크롤 가능
        LazyColumn(
            modifier = Modifier
                .fillMaxSize()
