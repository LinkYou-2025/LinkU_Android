...
object ServiceTermsData {
    ...
    val sections = listOf(
        ...
        "제 4 조 (이용계약의 체결)" to """
            1. 이용계약은 만 14세 이상인 자에 한하여 체결할 수 있습니다.
            2. 이용계약은 회원이 약관에 동의하고 회원가입을 완료함으로써 체결됩니다.
            3. 회사는 다음 각 호에 해당하는 경우 이용계약 체결을 거부하거나 사후에 해지할 수 있습니다.
        ...
        "제 15 조 (고객문의)" to """
            회원은 서비스 이용과 관련한 문의, 불만 또는 제안사항이 있을 경우 아래 연락처를 통해 문의할 수 있으며, 회사는 접수된 문의에 대해 합리적인 기간 내에 답변합니다.
            · 이메일: linku.cs@gmail.com
        """.trimIndent(),

        "부칙" to "본 약관은 2026년 09월 20일부터 시행됩니다."
    )
}